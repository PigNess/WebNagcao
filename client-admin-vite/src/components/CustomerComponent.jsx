...
class Customer extends Component {
  ...
  apiGetCustomers() {
    ...
    httpClient.get('/api/admin/customers', config).then((res) => {
  ...
  apiPutCustomerDeactive(id, token) {
    ...
    httpClient.put('/api/admin/customers/deactive/' + id, body, config).then((res) => {
      const result = res.data;
  ...
  apiGetCustomerSendmail(id) {
    const config = { headers: { 'x-access-token': this.context.token } };
    httpClient.get('/api/admin/customers/sendmail/' + id, config).then((res) => {
      const result = res.data;
  ...
  apiGetOrdersByCustID(cid) {
    const config = { headers: { 'x-access-token': this.context.token } };
    httpClient.get('/api/admin/orders/customer/' + cid, config).then((res) => {
      const result = res.data;
