...
class ProductDetail extends Component {
  ...
  apiPostProduct(prod) {
    const config = { headers: { "x-access-token": this.context.token } };
    httpClient.post("/api/admin/products", prod, config).then((res) => {
      const result = res.data;
      if (result) {
        alert("SUCCESS!");
        this.apiGetProducts();
  ...
  apiDeleteProduct(id) {
    const config = { headers: { "x-access-token": this.context.token } };
    httpClient.delete("/api/admin/products/" + id, config).then((res) => {
      const result = res.data;
      if (result) {
        alert("OK BABY !");
        this.apiGetProducts();
  ...
  apiPutProduct(id, prod) {
    const config = { headers: { "x-access-token": this.context.token } };
    httpClient.put("/api/admin/products/" + id, prod, config).then((res) => {
      const result = res.data;
      if (result) {
        alert("OK BABY !");
        this.apiGetProducts();
